...
<div class="container mb-24 px-6 mx-auto w-full bg-white py-20 ">

  <section class="text-gray-800 text-center">
  <div class="mx-auto mb-12 text-center md:max-w-xl lg:max-w-3xl">
  <h1 class="md:text-3xl mb-6 text-2xl font-medium title-font text-gray-900">
  ...
  <p class="pb-2 ">
    ...
    <div class="grid md:grid-cols-3 gap-x-6 lg:gap-x-12">
      <div class="mb-12 md:mb-0">
        ...
        <h6 class="font-medium text-blue-600 mb-4">JEE 2022</h6>
        <p class="mb-4">
      ...
      <div class="mb-12 md:mb-0">
        ...
        <h6 class="font-medium text-blue-600 mb-4">NEET 2023</h6>
        <p class="mb-4">
          <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="quote-left"
            class="w-6 pr-2 inline-block" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            <path fill="currentColor"
      ...
      <div class="mb-0">
        ...
        <h6 class="font-medium text-blue-600 mb-4">CBSE 2020</h6>
        <p class="mb-4">
          <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="quote-left"
            class="w-6 pr-2 inline-block" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            <path fill="currentColor"
